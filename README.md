...
#### [第43章：GT-MVVM架构(新品推荐：✪✪✪✪✪✪)](https://blog.csdn.net/qq_39799899/article/details/127093032?spm=1001.2014.3001.5501)(超简单GT_MVVM入门系列)
...
dependencies {
	//GT基础功能(必要的)
	implementation 'com.github.1079374315:GSLS_Tool:v1.4.4.0'
	//使用 gt-DataBinding 才需要添加以下注册,否则可以不添加
        annotationProcessor 'com.github.1079374315:GSLS_Tool:v1.4.4.0'//注册 gt-DataBinding 功能
...
dependencies {
	...
	implementation 'com.github.1079374315:GSLS_Tool:v1.4.4.0'
	//使用 gt-DataBinding 才需要添加以下注册,否则可以不添加
        kapt 'com.github.1079374315:GSLS_Tool:v1.4.4.0'//注册 gt-DataBinding 功能
