 ...
 * 更新内容：（1.3.7.5 版本 大爆料：新增 MVC、MVP、MVVM 辅助框架、GT.EventBus (数据传递)框架、Observable (异步)框架）
 * 内容如下：
...
dependencies {
	...
	//GT基础功能
	implementation 'com.github.1079374315:GSLS_Tool:v1.3.7.5'//如果不需要使用全部功能，可以只添加GT基础依赖。
